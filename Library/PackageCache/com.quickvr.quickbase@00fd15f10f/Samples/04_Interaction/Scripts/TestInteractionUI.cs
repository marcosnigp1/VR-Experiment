...
namespace QuickVR.SampleInteraction
{
    ...
    public class TestInteractionUI : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            {
                //Locomotion
                _interactionManager._locomotionDirectMoveEnabled = _toggleDirectMove.isOn;
                _interactionManager._locomotionDirectTurnEnabled = _toggleDirectTurn.isOn;
                _interactionManager._locomotionContinuousMoveEnabled = _toggleContinuousMove.isOn;
                _interactionManager._locomotionContinuousTurnEnabled =  _toggleContinuousTurn.isOn;
                _interactionManager._locomotionTeleportEnabled = _toggleTeleportLeftHand.isOn || _toggleTeleportRightHand.isOn;
                _interactionManager._locomotionWalkInPlaceEnabled = _toggleWalkInPlace.isOn;
