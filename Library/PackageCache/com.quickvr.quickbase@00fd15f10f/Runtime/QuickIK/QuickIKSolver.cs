...
namespace QuickVR
{
    ...
    public class QuickIKSolver : MonoBehaviour
    {
        ...
        public bool _updateIKHintPos = true;
        ...
        {
            //Reset the _upperBoneReference. 
            //PRE: The avatar is in T-Pose. Otherwise the assumptions we do about the orientation of the joints won't be correct. 
            ...
            _upperBoneReference.LookAt(_boneMid, fwdHint);
        }
        ...
        public virtual void RecomputeBonesLength()
        {
            _lengthUpper = Vector3.Distance(_boneUpper.position, _boneMid.position);
            _lengthMid = Vector3.Distance(_boneMid.position, _boneLimb.position);
        }
